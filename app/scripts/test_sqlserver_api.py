"""Test script for SQL Server API endpoints."""
import asyncio
import logging
import httpx
import json
...
async def user_token(client):
    ...
    test_user = {
        ...
        "email": "sqlserveruser@example.com",
        "password": "password123",
        "full_name": "SQL Server User"
    }
...
async def test_sqlserver_api() -> None:
    """Test the SQL Server API endpoints."""
...
async def test_notes_api(client: httpx.AsyncClient, user_token: str) -> None:
    ...
    # Create a note
    note_data = {
        "title": "SQL Server Test Note",
        "content": "This is a test note created by the SQL Server integration test",
        "visibility": "private",
        "tags": ["test", "sqlserver"]
    }
    ...
    # Update the note
    update_data = {
        "title": "Updated SQL Server Test Note",
...
if __name__ == "__main__":
    asyncio.run(test_sqlserver_api())
